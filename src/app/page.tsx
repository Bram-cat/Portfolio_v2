      ...
      <section className="relative py-20 sm:py-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-12 relative z-10">
            {/* Animated Status Badge with Neon Glow */}
            <div className="inline-flex items-center gap-2 px-6 py-3 rounded-full border border-cyan-500/30 bg-cyan-500/5 backdrop-blur-sm">
            ...
            <div className="space-y-6 relative">
              ...
              <div className="flex justify-center relative">
                <div className="absolute h-1 w-64 bg-gradient-to-r from-transparent via-purple-500 to-transparent rounded-full shadow-[0_0_20px_rgba(168,85,247,0.8)] blur-sm"></div>
                <div className="h-1 w-64 bg-gradient-to-r from-transparent via-cyan-500 to-transparent rounded-full shadow-[0_0_20px_rgba(34,211,238,0.8)] animate-pulse"></div>
              </div>
